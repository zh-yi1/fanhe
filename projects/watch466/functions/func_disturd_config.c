...
compo_form_t *func_disturd_sub_set_form_create(void)
{
    ...
    compo_shape_set_location(shape_bg, ALARM_NUM_PIC_CENTER_X-66, ALARM_NUM_PIC_CENTER_Y, 94, 166);
    ...
    compo_shape_set_location(shape_for, ALARM_NUM_PIC_CENTER_X-66, ALARM_NUM_PIC_CENTER_Y, 94-2, 166-2);
    ...
    compo_textbox_set_pos(txt_1, ALARM_NUM_PIC_CENTER_X, ALARM_NUM_PIC_CENTER_Y);
    ...
    compo_shape_set_location(shape_up, 160, 60, ALARM_NUM_PIC_WID, 42);

    compo_shape_t *shape_down = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_color(shape_down, COLOR_BLACK);

    compo_shape_set_location(shape_down, 160, 310, ALARM_NUM_PIC_WID, 124);
