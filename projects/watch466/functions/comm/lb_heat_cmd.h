 ...
 */
#ifndef __LB_HEAT_CMD_H
#define __LB_HEAT_CMD_H

#include "include.h"

#if FUNC_LUNCHBOX_UART_EN

// 保温固定参数: 194°F(≈90°C, 档位5), 时长 24 小时
#define LB_WARM_TEMP_F              194
#define LB_WARM_DURATION_MIN        (24u * 60u)
