...
/*===========================================================================
 * UI overlay — 由 new_ui/func_lock_page.c 实现
 *===========================================================================*/
...
/* 桩：home_ui_shared 缺失接口 */
extern void *home_ui_shared_status_bt_ram;
...
/* Stubs */
static void *home_ui_shared_status_bt_ram;
static inline void home_ui_shared_status_init(void) {}
static inline void home_ui_shared_status_refresh_bt(compo_picturebox_t *pic) { (void)pic; }
static inline void home_ui_shared_status_bind_bat(compo_picturebox_t *pic) { (void)pic; }
static inline void home_ui_shared_bt_icon_wake_reset(void) {}
static inline void home_ui_shared_battery_detach_pic(void) {}
static inline void home_ui_shared_ble_status_poll(void) {}
static inline void home_ui_shared_battery_chg_poll(void) {}
