...
// 0x01 产品信息查询挂起状态 → 已私有化到 func_lunchbox_ble_app.c
// BLE 时间同步 → 已迁移: 状态在 func_lunchbox_ui_state.c (lb_time_*), 流程在 func_lunchbox_ble_app.c

// 设备信息 (产品信息查询应答内容, 定义在 func_lunchbox_uart_app.c)
...
// 产品信息查询处理 → 已私有化到 func_lunchbox_ble_app.c (lb_ble_reply_product_info)
