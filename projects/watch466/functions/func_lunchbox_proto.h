 ...
 *
 *          不含: 发送队列/重试 (见 func_lunchbox_uart_txq)、通道选择、
 *                业务分发 (见 func_lunchbox_uart_app)。本层不依赖任何其他模块。
 */
#ifndef __FUNC_LUNCHBOX_PROTO_H
#define __FUNC_LUNCHBOX_PROTO_H
