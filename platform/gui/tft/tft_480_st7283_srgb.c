...
#if ((GUI_SELECT == GUI_LCD_480_ST7283))

static u8 refersh_dma_buf[GUI_SCREEN_WIDTH*GUI_SCREEN_HEIGHT*GUI_COLOR_DEPTH] AT(.psram_buf.lcd);

static void tft_480_st7283_srgb_set_brightness(uint8_t brightness)
{
    printf("%s\n", __func__);
}

lcd_drv_t lcd_480_st7283_drv = {
    .io = {
        .rgb_drv_io = {
            .data = {
                .dio = {
    ...
    .io_type = LCD_IO_SRGB8,
    .param = {
        .rgb_drv_param = {
            .clk_select     = LCD_SELECT_XOSC_CLK,
            .clk_div        = 0,
    ...
    .tft_set_window = NULL,
    .tft_read_id = NULL,
    .tft_set_brightness = tft_480_st7283_srgb_set_brightness,
    .tft_te_isr = NULL,
};
