...
#define QMC6309_WRITE_ADDR(ADDR)     	((ADDR) << 1)
#define QMC6309_READ_ADDR_UPDATE(ADDR)  ((ADDR) << 1 | 1)
#define QMC6309_READ_ADDR(ADDR)      	((ADDR) << 1 | 1) << 8 | ((ADDR) << 1)
...
#define QMC6309_LOG_EN					1

#if QMC6309_LOG_EN
#define QMC6309_LOG(...)               printf(__VA_ARGS__)
#else
#define QMC6309_LOG(...)
#endif
...
typedef struct {
	qmc6309_xyz_t 	raw;
	qmc6309_xyz_t 	result;
	qmc6309_xyz_t 	offset;
	float   		rr;
	int8_t			accuracy;
	qmc6309_xyz_t	acc;
	qmc6309_xyz_t   map;
...
extern qmc6309_qst_t qmc6309_qst;
