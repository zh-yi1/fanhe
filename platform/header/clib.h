...
#define print_f32(...)                  a_print_f32(__VA_ARGS__)
...
#define print_kf32(...)                 my_print_f32(__VA_ARGS__)
...
void a_print_f32(const void *buf, uint size);
...
#define print_f32(...)                  my_print_f32(__VA_ARGS__)
...
void my_print_f32(const void *buf, uint size);
